...
def main() -> None:
    ...
    if args.multitarget:
        ...
        predictions, metrics_by_fold, metrics_comparison, folds = run_multitarget_backtesting(
            datasets=datasets,
        ...
        outputs = {
            ...
            "metrics_by_fold": tables_dir / "metrics_by_fold_multitarget.csv",
            "metrics_comparison": tables_dir / "metrics_comparison_multitarget.csv",
            "folds": tables_dir / "backtesting_folds_multitarget.csv",
        }
    else:
