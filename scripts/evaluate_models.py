...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--versioned-outputs",
        action="store_true",
        help="Incluye run_id en las tablas generadas.",
    )
...
def main() -> None:
    ...
    outputs = {
        ...
        / _csv_name(f"metrics_by_fold{suffix}", run_id, args.versioned_outputs),
        "metrics_comparison": tables_dir
        / _csv_name(f"metrics_comparison{suffix}", run_id, args.versioned_outputs),
        "metrics_common_support": tables_dir
        / _csv_name(f"metrics_common_support{suffix}", run_id, args.versioned_outputs),
        "bias_summary_test_final": tables_dir
        / _csv_name(f"bias_summary_test_final{suffix}", run_id, args.versioned_outputs),
        "target_coverage_summary": tables_dir
        / _csv_name("target_coverage_summary", run_id, args.versioned_outputs),
        "error_analysis_by_route": tables_dir
        / _csv_name(f"error_analysis_by_route{suffix}", run_id, args.versioned_outputs),
        "error_analysis_by_hour": tables_dir
        / _csv_name(f"error_analysis_by_hour{suffix}", run_id, args.versioned_outputs),
        "error_analysis_by_day_type": tables_dir
        / _csv_name(f"error_analysis_by_day_type{suffix}", run_id, args.versioned_outputs),
        "error_analysis_by_target": tables_dir
        / _csv_name("error_analysis_by_target", run_id, args.versioned_outputs),
        "error_analysis_by_scenario": tables_dir
        / _csv_name("error_analysis_by_scenario", run_id, args.versioned_outputs),
        "error_analysis_by_dispatch_history_level": tables_dir
        / _csv_name("error_analysis_by_dispatch_history_level", run_id, args.versioned_outputs),
    }
    backups = {
